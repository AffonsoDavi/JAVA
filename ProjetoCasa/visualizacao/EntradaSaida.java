...
public class EntradaSaida {
	...
	public static int solicitaOpcao() {
		...
		JOptionPane.showConfirmDialog(null, menu, "Selecionea opcao desejada", JOptionPane.OK_CANCEL_OPTION);
		return menu.getSelectedIndex();
	}

	public static void exibeMsgEncerraPrograma() {
		JOptionPane.showMessageDialog(null, "o programa será encerrado", null, JOptionPane.WARNING_MESSAGE);
	}
	...
	public static void exibeMsgAbertura() {
		JOptionPane.showMessageDialog(null, "Nenhuma abertura será movimentada", null, JOptionPane.ERROR_MESSAGE);
	}

	public static void exibeInfoCasa(String informacoes) {
		JOptionPane.showMessageDialog(null, informacoes, "Informação da casa", JOptionPane.INFORMATION_MESSAGE);
	}

	public static void validaConstrucao() {
		JOptionPane.showMessageDialog(null, "Favor construir a casa primeiro", null, JOptionPane.ERROR_MESSAGE);
	}
}
